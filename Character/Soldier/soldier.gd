...
func _on_character_ready() -> void:
	...
	attack_module.setup(self, sprite, animation_tree, null, melee_hitbox, melee_hitbox_shape, stats, get_attack_cooldown(DEFAULT_ATTACK_COOLDOWN), _resolve_audio_manager())
