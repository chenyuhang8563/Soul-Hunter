...
func _on_character_ready() -> void:
	...
	attack_module.setup(self, sprite, animation_tree, null, melee_hitbox, melee_hitbox_shape, stats)
...
# Removed _physics_process_ai - AI handling now via base _physics_process_ai_default
