...
const SlimeAttackModuleScript := preload("res://Character/Common/slime_attack_module.gd")
...
@export var attack_cooldown := 0.50

func _on_character_ready() -> void:
	attack_module = SlimeAttackModuleScript.new()
